            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Cambia la password</h1>
                        <p class=""></p>
                        @if (\Session::has('message'))
                            ...
                            @endif
                            <p style="font-size: large">Inserisci una nuova password qui sotto.</p>
                        <form class="text-left" method="POST" action="{{url('change')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form">

                                <div id="username-field" class="field-wrapper input">
                                    <label for="username" style="font-size: large">Nuova password * </label>
                                 
                                    <input id="username" name="password" type="password" class="form-control" >
                                </div>
                                <div id="username-field" class="field-wrapper input">
                                    <label for="username" style="font-size: large">Reinserisci la nuova password *</label>
                                 
                                    <input id="username" name="passwordc" type="password" class="form-control" >
                                </div>
