                   ...
                   <div class="col-lg-12 col-12  layout-spacing">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h4>{{$dynamic->create}} {{$dynamic->customers}}</h4>
                            ...
                            <div class="widget-content widget-content-area">
                                <form style="padding: 5%;" method="POST" action="{{url('customers-store')}}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group mb-4">
                                        <label for="formGroupExampleInput">{{$dynamic->name}}</label>
                                        <input type="text" name="name" class="form-control" id="formGroupExampleInput" placeholder="" required="required">
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="formGroupExampleInput">{{$dynamic->email}}</label>
                                        <input type="text" name="email" class="form-control" id="formGroupExampleInput" placeholder="" required="required">
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="formGroupExampleInput">{{$dynamic->password}}</label>
                                        <input type="text" name="password" class="form-control" id="formGroupExampleInput" placeholder="" required="required">
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="formGroupExampleInput">{{$dynamic->phone}}</label>
                                        <input type="text" name="phone" class="form-control" id="formGroupExampleInput" placeholder="" required="required">
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="formGroupExampleInput">{{$dynamic->adults}}</label>
                                        <input type="text" name="adults" class="form-control" id="formGroupExampleInput" placeholder="" required="required">
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="formGroupExampleInput">{{$dynamic->children}}</label>
                                        <input type="text" name="children" class="form-control" id="formGroupExampleInput" placeholder="" required="required">
                                    </div>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="date" name="dateFrom" class="form-control" id="formGroupExampleInput" required="required">
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="formGroupExampleInput">Date To</label>
                                        <input type="date" name="dateTo" class="form-control" id="formGroupExampleInput" required="required">
                                    </div>
                                    <?php
                                    ...
                                    <div class="form-group mb-4">
                                     ...
                                     <div class="form-group mb-4">
                                        <label for="formGroupExampleInput">{{$field->english_label}} / {{$field->italian_label}}</label>
                                        <input type="time" name="{{$field->field_name}}" class="form-control" id="formGroupExampleInput" placeholder="" @if($field->is_mandatory=="Yes") required="required" @endif>
                                    </div>
                                     @endif
                                    ...
                                    <a href="{{url('customers/'.$hotel_id)}}" class="btn btn-warning">{{$dynamic->go_back}}</a>
                                </form>
                            </div>
                        </div>
                    </div>
