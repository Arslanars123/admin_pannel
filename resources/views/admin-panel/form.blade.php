        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        <img src="{{asset('admin-panel/assets/img/90x90.jpg')}}" class="navbar-logo" alt="logo">
                    </a>
                </li>
...
&lt;/select&gt;
    ...
    <script src="{{asset('admin-panel/plugins/highlight/highlight.pack.js')}}"></script>
    <script src="{{asset('admin-panel/assets/js/custom.js')}}"></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <script src="{{asset('admin-panel/assets/js/scrollspyNav.js')}}"></script>
</body>
</html>