                   ...
                   <div class="col-lg-12 col-12  layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <form style="padding: 5%;" method="POST" action="{{url('services-store')}}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <a href="{{url('services/'.$catId)}}" class="btn btn-warning">{{$dynamic->go_back}}</a>
                                </form>
                            </div>
                        </div>
                    </div>
