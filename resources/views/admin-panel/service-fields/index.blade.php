                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            ...
                            @endif
                            <a href="{{url('service-fields-create')}}" style="padding: 10px;">{{$dynamic->createl}} +</a>
                            <table id="zero-config" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$servicefield->english_label}}</td>
                                        <td>{{$servicefield->italian_label}}</td>
                                        <td>{{$servicefield->field_type}}</td>
                                        <td>{{$servicefield->is_mandatory}}</td>
                                        <td>{{$servicefield->orderNo}}</td>
                                        <td><div class="icon-container">
                                            <a href="{{url('service-fields-edit/'.$servicefield->id)}}"><i data-feather="edit"></i><span class="icon-name"> {{$dynamic->editl}}</span></a>
                                            <a href="{{url('service-fields-delete/'.$servicefield->id)}}">
