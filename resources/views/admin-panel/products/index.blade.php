                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            ...
                            @endif
                            <a href="{{url('products-create/'.$catId)}}" style="padding: 10px;">{{$dynamic->createl}} +</a>
                            <table id="zero-config" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$product->price}}</td>
                                        <td><img src="{{asset($product->image)}}" style="width: 30px"></td>
                                        @foreach($fields as $field)
                                        ...
                                        <?php
                                         ...
                                         ?>
                                        <td>{{$product[$nam_en]}}</td>
                                        <td>{{$product[$nam_it]}}</td>
                                        @endif
                                        @if($field->field_type!="string")
                                        <td>{{$product[$field->field_name]}}</td>
                                        @endif
                                        @endforeach
                                        <td><div class="icon-container">
                                            <a href="{{url('products-edit/'.$product->id)}}"><i data-feather="edit"></i><span class="icon-name"> {{$dynamic->editl}}</span></a>
